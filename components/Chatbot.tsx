...
const Chatbot: React.FC = () => {
  ...
  const handleSendMessage = async (e: FormEvent) => {
      ...
      try {
        ...
        - If the user provides a command to add stock but the price is ambiguous (e.g., "Add 5 milk at 200"), DO NOT guess. 
        - Ask the user to clarify: "Is that ₹200 per item or for the total quantity?"
        - Only call the 'addStockItem' function when you are sure about the price per unit.
        ...
        // REMOVED googleSearch to resolve "Tool use with function calling is unsupported" error (400)
        ...
        let errMsg = t('chatbotError');
        // Provide more detail if it's a known error type
        ...
        const errorMessage: Message = { text: errMsg, sender: 'bot' };
