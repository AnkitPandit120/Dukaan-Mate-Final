...
import { Sale, StockItem, Payment, Expense, PaymentStatus, Feedback, Issue } from '../types';
...
export const mockFeedback: Feedback[] = [
    { id: 'f1', userId: 'user-1', userName: 'Rahul Kumar', rating: 5, comment: 'Great app for my grocery store! Rush mode is a lifesaver.', date: formatDate(new Date(new Date().setDate(today.getDate() - 2))) },
    { id: 'f2', userId: 'user-2', userName: 'Priya Singh', rating: 4, comment: 'Love the reports. Would like more colors in charts.', date: formatDate(new Date(new Date().setDate(today.getDate() - 5))) },
    { id: 'f3', userId: 'user-3', userName: 'Amit Shah', rating: 5, comment: 'Inventory tracking is very accurate.', date: formatDate(new Date(new Date().setDate(today.getDate() - 10))) },
];

export const mockIssues: Issue[] = [
    { id: 'i1', submittedBy: 'Rahul Kumar', contact: 'rahul@dukaan.com', category: 'Voice', description: 'Rush mode failed to understand "20kg rice".', timestamp: formatDateTime(new Date(new Date().setDate(today.getDate() - 1))), status: 'Open', hasScreenshot: true },
    { id: 'i2', submittedBy: 'Priya Singh', contact: '9876543210', category: 'Stock', description: 'Export CSV button not working on mobile.', timestamp: formatDateTime(new Date(new Date().setDate(today.getDate() - 3))), status: 'In-Progress', adminNote: 'Investigating mobile layout.' },
    { id: 'i3', submittedBy: 'Amit Shah', contact: 'amit@store.com', category: 'Login', description: 'Password reset link expired too fast.', timestamp: formatDateTime(new Date(new Date().setDate(today.getDate() - 7))), status: 'Resolved', adminNote: 'Increased expiry time.' },
];
